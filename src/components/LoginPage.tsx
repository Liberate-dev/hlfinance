      ...
      <div className="w-full max-w-[420px] bg-white rounded-2xl shadow-xl shadow-slate-200/80 border border-slate-100/80 p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-slate-200/90">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 py-3 px-4 bg-[#002B8F] hover:bg-[#001E66] disabled:opacity-60 text-white text-sm font-bold rounded-xl shadow-lg shadow-blue-900/10 hover:shadow-xl hover:shadow-blue-900/20 active:transform active:scale-[0.98] transition-all duration-150"
          >
