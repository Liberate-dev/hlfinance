-- Rich seed data for evaluating Laporan (reports)
-- Safe to re-run: removes previous SEED-* transactions first
-- Prerequisite: run 20240613000002_seed_dev.sql (customers + products)
...
-- Extra customers for pagination & variety in report table
